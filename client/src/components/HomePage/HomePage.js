...
import './HomePage.css'
import { Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Link, Grid, CssBaseline, Box } from '@mui/material'
  ...
  return (
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: '60vh' }}>
        ...
        />
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square id="home-about">
          <Box
            sx={{
              my: 8,
              mx: 4,
          ...
          >
          <div>
            <Typography variant="h3" component="h3">About Elephant-List</Typography >
            <br></br>
            <Typography variant="h6" component="h6">Elephant-List is designed to build a community of those who are able to donate quality items related to parenthood. Anything from diapers that no longer fit your growing child to breast-pumps, baby bottles, toys, or books. </Typography>
            <br></br>
            <Typography variant="subtitle1" component="h6">If you have anything that might be helpful in the hands of a another family, Elephant-List is here to help you get connected. </Typography>
          </div>
          </Box>
        </Grid>
      </Grid>
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: '60vh' }}>
        <CssBaseline />
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square id="home-resources">
          <Box
            sx={{
              my: 8,
              mx: 4,
         ...
         <div id="home-resources">
          <Typography variant='h5' component="h6">Additional resources in the DFW area</Typography>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: "url(%PUBLIC_URL%../../../../pictures/bottom.jpg)",
            backgroundRepeat: 'no-repeat',
            backgroundColor: (t) =>
              t.palette.mode === 'light' ? t.palette.grey[50] : t.palette.grey[900],
            backgroundSize: 'cover',
